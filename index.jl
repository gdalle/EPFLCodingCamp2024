...
# ╔═╡ be863d2c-65d7-11ef-3ace-4fd9d8fca6ed
begin
...
# ╔═╡ 9679489e-769e-4b6f-bd8b-efb5ea2a2c3e
md"""
# Overview
"""

# ╔═╡ 197cda9c-84f1-4f33-b5a5-7a1dce9c627b
md"""
## Challenge
"""

# ╔═╡ 951d8d28-2128-43d2-8c88-b3ab6c486cc5
md"""
This challenge is taken from Google Hash Code, an annual team programming competition.
Its 2014 edition was about routing cars with cameras through Paris, making them capture as much street data as possible within a limited time frame.

The first thing you need to do is read the official [problem statement](https://storage.googleapis.com/coding-competitions.appspot.com/HC/2014/hashcode2014_final_task.pdf).
"""

# ╔═╡ 8880faff-884b-4e21-8466-1a40957b68ff
md"""
## Package
"""

# ╔═╡ 18dec9e5-ad4b-404e-b178-e7019129e4e7
md"""
I wrote a small package called [GoogleHashCode2014.jl](https://github.com/gdalle/GoogleHashCode2014.jl) to help you get started.
...
Check out its [documentation](https://gdalle.github.io/GoogleHashCode2014.jl/) for more details. You can also look at the code itself for inspiration.
"""

# ╔═╡ b316f168-d880-41ed-ab36-fcdbab699fa8
city = read_city()

# ╔═╡ 28037e8f-c7e1-411a-b035-851af3b346c9
city.junctions[1]

# ╔═╡ 5c075d29-9015-4eb6-ae79-a86977771b36
city.streets[1]
...
# ╔═╡ 20baefc8-7bee-4b77-81b8-58e576774721
total_distance(solution, city)

# ╔═╡ d693a635-f8f9-4c3b-bd7d-6019629d5827
plot_streets(city, solution)

# ╔═╡ 779f4c26-16c8-4847-82ce-b5ba3fdaa132
md"""
# Algorithms
"""

# ╔═╡ 4c705c3b-c28e-4c3b-bfc5-a3280c729391
md"""
Describe the methods you come up with.
"""

# ╔═╡ de8a886a-b495-4f6c-9c1e-d7a93d1aa4d8
md"""
# Implementation
"""

# ╔═╡ e54707a4-9443-419b-b0ac-4ad89706f9fb
# code your algorithms

# ╔═╡ a03d762c-cc82-4526-8b80-fc145c97a822
md"""
# Evaluation
"""

# ╔═╡ 92642109-82cc-4436-8098-71d78a422317
# measure performance
...
manifest_format = "2.0"
project_hash = "d01a3ccf4e50ba522c73c159a8637a95b8ba5616"
...
git-tree-sha1 = "045b3dc30fd2fd5777107955e2c9b8d47f087de1"
...
git-tree-sha1 = "38ab7e40ef159b4d492b4f79839445459738d807"
